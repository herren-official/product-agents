...
| gongbiz-crm-iOS | Swift/UIKit/RxSwift/MVVM | requirements-analyst, **crm-ios-notion-analyzer**, **crm-ios-slack-analyzer**, **crm-ios-figma-ui-analyzer**, **crm-ios-figma-policy-analyzer**, **crm-ios-component-mapper** | **crm-ios-task-planner**, **crm-ios-notion-writer** | **crm-ios-code-analyzer**, **crm-ios-side-effect-analyzer** | **crm-ios-task-executor**, **crm-ios-code-implementer**, debugger | **crm-ios-test-writer**, **crm-ios-build-checker** | **crm-ios-implementation-verifier**, **crm-ios-side-effect-verifier**, code-simplifier | ship-checklist | 서비스 전용 에이전트 15개 + 스킬 17개 (v.8.12.22 기반) |
