...
if __name__ == "__main__":
    ...
    parser.add_argument("--repo", type=str, default="herren-official/instaget-server", help="GitHub 레포지토리 (owner/repo)")
